...
// Updated	2020-04-27 by Dave Henderson (dhenderson@cliquesoft.org or support@cliquesoft.org)
//
...
// http://stackoverflow.com/questions/11381673/javascript-solution-to-detect-mobile-browser
	if (/android|webos|iphone|ipad|ipod|blackberry|iemobile|opera mini|mobile/.test(navigator.userAgent.toLowerCase())) {
		if (typeof jQuery !== 'undefined') { jQuery.fx.off = true; }		// globally toggle jQuery effects (if jQuery is installed)
		Mobile=1;
	}
}
